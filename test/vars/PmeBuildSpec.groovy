...
class PmeBuildSpec extends JenkinsPipelineSpecification {
    ...
    def "[pmebuild.groovy] build with branch and change author"() {
        ...
        when:
        groovyScript.buildProjects(projectCollection, 'settingsXmlId', 'buildConfigPathFolder', 'pmeCliPath', ['variable1': 'value1'], ['projectC-scmRevision': 'branchX'], ['version1': 'valueVersion1'])
        then:
        ...
        assert env['PME_BUILD_VARIABLES'].contains('projectC-scmRevision=branchX')
    }
}
